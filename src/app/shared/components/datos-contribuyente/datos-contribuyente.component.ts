  ...
  generarPoliza_response(): void {
    ...
    let id = setInterval(() => {
      if (estadoPeticion) {
        ...
        //this.dataPoliza.datosVehiculo!.tipo = vehicle_data.tramite;
        if (this.dataPoliza.datosVehiculo && vehicle_data?.tramite) {
          this.dataPoliza.datosVehiculo.tipo = vehicle_data.tramite;
        }
