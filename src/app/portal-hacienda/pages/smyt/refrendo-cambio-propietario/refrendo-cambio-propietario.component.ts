...
@Component({
  selector: 'app-refrendo-cambio-propietario',
  templateUrl: './refrendo-cambio-propietario.component.html',
  styles: [
  ]
})
export class RefrendoCambioPropietarioComponent implements OnInit, AfterContentInit, OnDestroy {
