...
@Component({
  ...
  styleUrls: ['./alta-vehiculo-sin-registro.component.css']
})
export class AltaVehiculoSinRegistroComponent implements OnInit, AfterContentInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.conceptTitle.set(sessionStorage.getItem('concept')!);//localStorage.getItem('concept_admin')!);
    let msg: string = '';
