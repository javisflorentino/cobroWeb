...
@Component({
  selector: 'app-cambio-propietario',
  templateUrl: './cambio-propietario.component.html',
  styles: [
  ]
})
export class CambioPropietarioComponent implements OnInit, AfterContentInit, OnDestroy {
